...
** first we need the variable of majors , unemployment rate. in python we could brute force this with code and co through each major and compare it to the employment rate and if it is lower than the previous  we keep it and if not we throw it out and at the end we would have the major with the lowest unemployment rate   **:
